  ...
  return (
    ...
    >
      {isEditing ? (
        ...
        <>
          <div className="mb-4">
            <h3 className={`text-xl font-bold mb-2 ${theme === "dark" ? "text-white" : "text-slate-900"}`}>{course.name}</h3>
            <p className={`text-sm mb-3 ${theme === "dark" ? "text-gray-400" : "text-slate-600"}`}>{course.des}</p>
            ...
            <div className={`text-xs mb-2 ${theme === "dark" ? "text-gray-500" : "text-slate-500"}`}>
