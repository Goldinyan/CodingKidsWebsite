          ...
          >
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  className={`px-8 py-3 font-medium border transition-all duration-200 hover:scale-105 active:scale-100 flex items-center justify-center gap-2 group ${theme === "dark"
