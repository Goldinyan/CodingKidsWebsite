...
<div>
	...
	<div className="flex gap-2">
		<button
			...
			className={`flex-1 px-3 py-2 text-sm font-medium ${loading || selectedAssignee === user?.uid ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"
		...
		{selectedAssignee && (
			<button
				...
				disabled={loading}
				className={`px-3 py-2 text-sm font-medium ${loading ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"
					} ${theme === "dark"
