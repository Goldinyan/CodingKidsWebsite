    ...
    return (
      <span
        className={`flex items-center gap-1 text-[10px] px-2 py-1 rounded-md ${
          theme === "dark" ? "bg-white/5 text-zinc-400" : "bg-zinc-200 text-zinc-600"
        }`}
        style={baseStyle}
      >
    ...
    >
      ...
      >
        ...
        >
          <div
            className={`text-[9px] tracking-widest transition-colors ${
              isInEvent ? "text-emerald-500/70" : theme === "dark" ? "text-zinc-500" : "text-zinc-600"
            }`}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            className={`text-[11px] flex items-center flex-wrap gap-x-3 gap-y-1 ${
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            <div className={`px-5 pb-5 border-t ${theme === "dark" ? "border-white/06" : "border-zinc-200"}`}>
              <div className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2 flex flex-col gap-4">
                  <div>
                    ...
                    <p className={`text-xxs leading-relaxed ${theme === "dark" ? "text-zinc-400" : "text-zinc-700"}`}>
                      {event.description}
                    </p>
                  </div>
                  ...
                  <div>
                    <div
                      className={`text-[10px] uppercase flex flex-row tracking-widest mb-1.5 ${
                        theme === "dark" ? "text-zinc-500" : "text-zinc-600"
                      }`}
                      style={{ fontFamily: "'JetBrains Mono', monospace" }}
                    >
                  ...
                  <div>
                    ...
                    <p className={`text-xxs mt-2 leading-relaxed ${theme === "dark" ? "text-zinc-400" : "text-zinc-700"}`}>
                      {course.des}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  <div className={`rounded-xl border p-4 ${
                    theme === "dark" ? "bg-white/[0.02] border-white/06" : "bg-zinc-100/50 border-zinc-200"
                  }`}>
                    <div
                    ...
                    >
                      ...
                      <span style={{ color: spotsLeft === 0 ? "#ef4444" : "#22c55e" }}>
                        {spotsLeft} frei
                      </span>
                    </div>

                    {/* Progress Bar */}
                    <div className={`h-1.5 rounded-full mb-3 ${theme === "dark" ? "bg-white/10" : "bg-zinc-200"}`}>
                      <div
                  ...
                  {!isPast && (
                    <Button
                      ...
                      className={`w-full py-2.5 text-sm font-bold flex items-center justify-center gap-2 transition-all duration-200 ${
                        isRounded ? "rounded-xl" : "rounded-none"
                      } ${
                        tooEarly
