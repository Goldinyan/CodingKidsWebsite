		...
		>
			...
			{isUploading ? (
				...
				<div className="flex-1 flex flex-col items-center justify-center text-center p-4">
					...
					<button
						/*onClick={() => fileInputRef.current?.click()}*/
						className={`px-4 py-2 border font-['JetBrains_Mono'] cursor-not-allowed text-[11px] font-bold tracking-wider uppercase transition-colors ${innerRoundedClass} ${theme === "dark"
