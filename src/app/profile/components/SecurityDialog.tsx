    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div
              className={`p-6 border transition-all duration-150 ${roundedClass} ${theme === "dark"
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex flex-col gap-1">
                  <span
                    className={`block font-mono text-[10px] font-bold tracking-widest uppercase ${theme === "dark" ? "text-zinc-500" : "text-slate-400"
                      }`}
                  >
                ...
                <button
                  onClick={() => onOpenChange(false)}
                  className={`p-1.5 transition-colors ${innerRoundedClass} ${theme === "dark"
              ...
              <div
                className={`flex gap-1 p-0.5 border ${innerRoundedClass} ${theme === "dark"
              ...
              >
                {(["email", "password"] as const).map((tab) => (
                  <button
                    ...
                    className={`flex-1 py-1.5 text-xs font-medium transition-all duration-150 ${innerRoundedClass} ${activeTab === tab
                        ? theme === "dark"
              ...
              <AnimatePresence mode="wait">
                {alert && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -4 }}
                    className={`flex items-start gap-2.5 p-3 text-xs ${innerRoundedClass} border ${alert.type === "success"
                        ? theme === "dark"
              ...
              >
                {activeTab === "email" ? (
                  <>
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border transition-all duration-150 text-sm font-sans outline-none ${innerRoundedClass} ${theme === "dark"
                  ...
                  <>
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div
                        className={`flex items-center gap-2 px-3 border transition-all duration-150 ${innerRoundedClass} ${theme === "dark"
                      ...
                      >
                        <input
                          ...
                          className={`flex-1 py-2 bg-transparent outline-none text-sm font-sans ${theme === "dark"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-2 px-4 font-sans font-bold text-xs transition-all duration-150 border uppercase tracking-wider disabled:opacity-40 disabled:cursor-not-allowed mt-2 ${innerRoundedClass} ${theme === "dark"
