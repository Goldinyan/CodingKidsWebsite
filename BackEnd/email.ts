...
export async function removedFromEventByAdmin(
  to: string,
  eventName: string,
  reason?: string,
) {
...
export async function eventGotDeleted(
  to: string,
  eventName: string,
  reason?: string,
) {
...
export async function sendAccountCreationEmailToAdmin(
  userName: string,
  userEmail: string,
) {
...
export async function sendAccountDeletionEmailToAdmin(
  userName: string,
  userEmail: string,
) {
